...
# #
mapfile = nc.Dataset(
    r"p:\11205209-rejuvenationzuidgors\Zuidgors_modelling\Zuidgors_bigger\input\output_Spart_Sali_Ely\\Zuidgors_bigger_map.nc",
    "r",
)
...
fig = plt.figure(figsize=(12, 8))
fig = plt.tricontourf(x, y, bed_level[-1, :], cmap="terrain", levels=np.linspace(-2, 4, 200))
