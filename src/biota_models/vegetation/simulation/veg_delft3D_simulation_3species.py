...
from src.biota_models.vegetation.simulation.veg_simulation_3species import (
    VegetationBiotaWrapper,
    _VegetationSimulation_3species,
)
from src.core.hydrodynamics.delft3d import Delft3D


class _VegDelft3DSimulation(_VegetationSimulation_3species, ABC):
    """
...
class VegFlowFmSimulation_3species(_VegDelft3DSimulation):
    """
